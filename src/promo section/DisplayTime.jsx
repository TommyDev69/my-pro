  ...
  if (isEnded) {
    ...
    return ( 
        <div className="flex items-center  space-x-1 md:space-x-3 ">
            ...
            <div className="flex flex-col  border-2 border-[rgb(242,129,35)] items-center  justify-center text-[rgb(242,129,35)]">
                <p className="md:text-[20px] text-[16px] font-bold p-2 md:p-4 md:font-bitcount">{TimeLeft.mins}</p>
                <p className="text-sm md:text-2xl capitalize">mins</p>
            </div>
            <div className="flex flex-col  border-2 border-[rgb(242,129,35)] items-center  justify-center text-[rgb(242,129,35)]">
                <p className="md:text-[20px] text-[16px] font-bold p-2 md:p-4 md:font-bitcount">{TimeLeft.secs}</p>
