      ...
      <div className="hidden md:flex">
        <div className="relative content flex md:flex-row gap-6 text-2xl text-white md:py-10 py-14">
          ...
          >
            ...
            >
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize">404 page</a>
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize">about</a>
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize">cart</a>
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize">check out</a>
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize">contact</a>
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize">news</a>
              <a href={link} className="px-4 py-2 hover:bg-[#F28123] capitalize rounded-b-xl">shop</a>
            </div>
          </div>
