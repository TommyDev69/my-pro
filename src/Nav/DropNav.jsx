        ...
        <div className="fixed top-32 left-0  z-50 bg-[#051922] w-full md:hidden transition-all duration-500 ease-in-out overflow-y-auto">
            <div className="content divide-y divide-[#ffffff22] flex flex-col text-2xl text-white py-0">
                ...
                <div className="bg-[#00000044] text-lg text-white p-4 transition-all duration-500 ease-in-out">
                    <a href={link} className="block py-4 uppercase hover:bg-[#F28123]">static home</a>
                    <a href={link} className="block py-4 uppercase hover:bg-[#F28123]">slider home</a>
                </div>
                )} */}
                ...
                <div className="bg-[#00000044] md:text-xl text-[16px] text-white px-3  duratiovn-500 ease-in-out">
                    ...
                    <Link to ="/Checkout" onClick={handleLinkClick}  className="block py-4 uppercase  hover:bg-[#F28123]">check out</Link>
                    <Link to ="/Contact" onClick={handleLinkClick}  className="block py-4 uppercase  hover:bg-[#F28123]">contact</Link>
