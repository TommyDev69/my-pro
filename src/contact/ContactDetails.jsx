...
export default function ContactDetails() {
  return (
    <div
      className="bg-cover rounded-3xl w-3/12 my-14  pb-10 bg-center h-[60vh] flex flex-col text-black justifey-center pl-6"
    ...
    >
      <div className="flex items-center pt-6  space-x-3  text-[24px]  rounded-xl">
       ...
       <address className="not-italic px-14 text-[18px] text-[#5a5858] w-8/12">123 Fruit Lane, Lagos, Nigeria.</address>
      ...
      <div className="flex ">
       ...
       <p className="not-italic pl-14 text-[15px] text-[#5a5858] ">MON - FRIDAY:</p>
       <p className="not-italic  text-[15px] pl-1 text-[#5a5858] "> 8 to 9 PM</p>
      </div>
      <div className="flex ">

       <p className="not-italic pl-14 text-[15px] text-[#5a5858] ">SAT - SUN: </p>
