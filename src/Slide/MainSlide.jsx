...
const Mainslide = ({ Info }) => {
   const [data,setData] = useState([
    {id:1, Image:img1, name:'Ajabge Tomiwa', alias:'linux', title:'software develop', content:'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsam sunt quod beatae corrupti atque velit quos et aperiam, expedita dolorem, repellendus sint. Itaque, architecto! Non ad eius labore cum iusto.'},
