...
export default function AllNews({AllData, icon_1, icon_2}) {
  return (
    <div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 my-24 container mx-auto gap-8 md:gap-16 py-10 ">
                {AllData.map((blog)=>(
                    <div className="flex-grow-0 w-11/12  md:w-10/12 mx-auto md:mx-0  hover:border-none hover:shadow-[rgb(242,129,35)] shadow-[black] shadow-xl border-2 rounded-3xl" key={blog.id}>
